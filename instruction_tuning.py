...
def parse_args():
    ...
    parser.add_argument("--model_name_or_path", type=str, default="meta-llama/Llama-3.2-1B", help="Model name or path to local checkpoint")
...
def main():
    ...
    raw_dataset = load_from_disk('/mnt/DATA/datasets/final_dataset')
